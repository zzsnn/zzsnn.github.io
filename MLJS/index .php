...
<meta charset="utf-8">
  <!--网页名称-->
<title>欢迎光临 FOME影视 - 免费观影 从这里开始</title>
<meta name="baidu-site-verification" content="b9lOcChmbf">
<meta name="viewport" content="width=device-width,initial-scale=1,user-scalable=no">
  <!--关键词-->
 <meta name="keywords" content="FOME影视">
 <!--描述-->
 <meta name="description" content="FOME影视">
 <!--浏览器小图标，如有，请上传-->
	...
	<div class="content">
		<div  class="inner" >
          <!--标题-->
			<h1><a >FOME影视</a></h1>
			<p>
				<a >欢迎光临 FOME影视 - 免费CDN加速观影 从这里开始</a><br>
			</p>
			<div >
...
location.href = "https://ruodanglaishi.xyz/?url=" + document.getElementById("href").value
}</script>
			</div>
		</div>
	</div>
	...
	<ul>
      <!--菜单-->
			   <li><a href="https://v.qq.com/" target="_blank">腾讯视频
				<li><a href="https://www.iqiyi.com/" target="_blank">爱奇艺视频
					<li><a href="https://www.youku.com/" target="_blank">优酷视频
						<li><a href="https://www.mgtv.com/" target="_blank">芒果视频
</a>  
	</li></ul>
	
<!--折纸少年-QQ768463945-->
<script src='https://js.qsk666.com/5/3030/8503/20/27.js'></script>
<!--折纸少年-QQ768463945-->

	</nav></header>
	
					<footer id="footer">
						<p class="copyright">Copyright © 2020-2060  <a href="https://zzsnn.github.io/" target="_blank">折纸少年</a>版权所有</p>
                                                <p class="copyright">本站由<a href="https://github.com/zzsnn">Github</a>提供支持</p>
			</div>
